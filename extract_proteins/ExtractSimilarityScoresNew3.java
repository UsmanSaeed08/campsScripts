...
public class ExtractSimilarityScoresNew3 {
...
public void run() throws Exception {
			...
			while(rsCount.next()){ //for every sequenceid in sequences, do below
				...
				new ReadHitsThreadNew3(seqid, startArray, endArray, CAMPS_CONNECTION, MAX_EVALUE, MIN_LENGTH_RATIO); // in this function, retreive EACH hit for seqid and classify them as tm and non tm and calc param
